...
public class WritePostController {
  ...
  @GET @Url("/write")
  public Response get() throws ServletException, IOException {
    return new JamonResponse(templates.newEssay().makeRenderer());
  }

  @GET @Url("/write/{essayId}")
  public Response getEssay(String essayId) {
  ...
  @POST @Url("/write")
  public Response doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
  ...
  public Response doPut(String essayId) {
    TentClient tentClient = newTentClient();
